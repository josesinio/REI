...
var connetionString = builder.Configuration.GetConnectionString("Proyecto_db");

//agrego la configuracion al nuestro contexto AplicacionDbContexto
builder.Services.AddDbContext<AplicacionDbContext>(opcion
=> opcion.UseMySql(connetionString, new MySqlServerVersion(new Version(8, 0, 30))));
...
opciones.UseMySql(connetionString, new MySqlServerVersion(new Version(8, 0, 30)));
